import { menuItemsType } from 'src/types/menuItemsType';
export const menuItems: menuItemsType = [
  ...
  },
  {
    ...
    icon: 'majesticons:image-circle',
    link: paths.logo_website.link,
  },
  {
    isHeadr: true,
    title: 'Management',
  },
  {
    ...
    child: [
      {
        childtitle: paths.section_hero.title,
        childlink: paths.section_hero.link,
      },
      {
        childtitle: paths.section_partners.title,
        childlink: paths.section_partners.link,
      },
      {
        childtitle: paths.section_subscribe.title,
        childlink: paths.section_subscribe.link,
      },
    ],
  },
  {
    title: 'Images',
    icon: 'ph:images-square-light',
    isHide: true,
    child: [
      {
        childtitle: 'Hero images',
        childlink: 'hero-images',
      },
      {
...
import User1 from 'src/assets/images/all-img/user.png';
import User2 from 'src/assets/images/all-img/user2.png';
import User3 from 'src/assets/images/all-img/user3.png';
import User4 from 'src/assets/images/all-img/user4.png';
...
import meetsImage1 from 'src/assets/images/svg/sk.svg';
import meetsImage2 from 'src/assets/images/svg/path.svg';
import meetsImage3 from 'src/assets/images/svg/dc.svg';
import meetsImage4 from 'src/assets/images/svg/sk.svg';
...
import file1Img from 'src/assets/images/icon/file-1.svg';
import file2Img from 'src/assets/images/icon/pdf-1.svg';
import file3Img from 'src/assets/images/icon/zip-1.svg';
import file4Img from 'src/assets/images/icon/pdf-2.svg';
import file5Img from 'src/assets/images/icon/scr-1.svg';
