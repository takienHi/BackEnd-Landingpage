...
import { handleCustomizer } from 'src/store/layout';
...
const Setings = () => {
  const isOpen = useSelector((state: any) => state.layout.customizer);
  const dispatch = useDispatch();
  // ** Toggles  Customizer Open
  const setCustomizer = (val: any) => dispatch(handleCustomizer(val));
