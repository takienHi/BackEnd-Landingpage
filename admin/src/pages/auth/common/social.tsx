// import images
import Twitter from 'src/assets/images/icon/tw.svg';
import FaceBook from 'src/assets/images/icon/fb.svg';
import LinkedIn from 'src/assets/images/icon/in.svg';
import Google from 'src/assets/images/icon/gp.svg';
